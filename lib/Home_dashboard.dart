...
class HomeDashboard extends StatefulWidget {
  ...
  @override
  State<HomeDashboard> createState() => _ProductsState();
}

class _ProductsState extends State<HomeDashboard> {
  @override
          ...
          children: [
                  ...
                  child: Stack(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20),
                          color: const Color.fromARGB(255, 11, 99, 3),
                        ),
                        // color: Colors.amber,
                        child: FittedBox(
                          fit: BoxFit.fill,
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 185.0, top: 40),
                        child: Stack(
                          children: [
                            Text(
                              "Christmas Offer",
            ...
            Row(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 202.0, top: 10),
                  child: Text(
                    "See all",
